...
> Based on [jesuswasrasta's](https://github.com/jesuswasrasta/dotfiles) dotfile config
...
Yes, there are many _cache_, _temp_ and _machine related_ files there's no need to include (or that can be dangerous to include), like:
